...
<div class="stadic_layout_head stadic_head_height" style="background-color:#dadada">
   ...
   <span class="ico16 close_16 cursor-hand" onclick="hideFileList();"></span>
...
if(mainType==2){
  ...
  %>
   ...
   <td class="align_left" class="w30b" >
   <div style="word-break:keep-all; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;">
    <a style="text-decoration:none;" href="javascript:download('<%=uuid%>')" title="点击查看"><img id="list_doc_span<%=i %>" class="ico16"/>
   <script>
   <%
   if(subType==2){
  ...
  </img></a><a style="font-size:12px;color:#757575;text-decoration:none;" href="javascript:download('<%=uuid%>')" title="点击查看"><%=fileName %></a></span>
  </div>
  </td>
