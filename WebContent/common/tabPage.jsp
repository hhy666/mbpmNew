	...
	<script> 
		var MtabContainer0 = isc.TabSet.create({
				...
				tabBarControls : [
				 ...
				 tabs: [ 
				 	{
				 	title: "部门",pane:isc.HTMLPane.create({
				 	...
				 	,
				 	{title: '角色',pane:isc.HTMLPane.create({
				 		ID:"MtabContainer0Panel4",height: "100%",
				 		overflow: "hidden",
				 		autoDraw: false,
				 		showEdges:false,
				 		contentsType:"page",
				 	...
				 	{title: "人员",pane:isc.HTMLPane.create({
...
<script>
	...
	MtabContainer0Panel0.setContentsURL('orgSelectUserPage.jsp?selectType=${param.selectType}&iframewindowid=${param.iframewindowid}');
	MtabContainer0Panel4.setContentsURL('roleSelectUserPage.jsp?selectType=${param.selectType}&iframewindowid=${param.iframewindowid}');
	MtabContainer0Panel3.setContentsURL('userInfoPage.jsp?selectType=${param.selectType}&iframewindowid=${param.iframewindowid}');
