...
<head>
		...
		window.onload=function(){
			Matrix.showMask();
			Matrix.setFormItemValue('loadData','1');
...
    	});
		...
		window.onblur=function(){
			Matrix.setFormItemValue('loadData','0');
		}
		</script>
</head>
<body>
...
<script>
 var MForm0=isc.MatrixForm.create({
 				...
 				name:"MForm0",
 				position:"absolute",
 				action:"<%=request.getContextPath()%>/select/user_queryUserInfoList.action",
 				fields:[{
...
<form id="Form0" name="Form0" eventProxy="MForm0" method="post"
	...
	<input type="hidden" id="loadData" name="loadData" value="0"/>
...
<script> var MDataGrid004_DS=[];
	...
	isc.MatrixListGrid.create({
		...
		fields:[
			...
			{title:"部门",matrixCellId:"userDep",name:"userDep",canEdit:false,editorType:'Text',type:'text'}
