...
(function (factory) {
    ...
    if (typeof define === 'function' && define.amd) { // jshint ignore:line
        ...
        define(['public/static/js/jquery'], factory); // jshint ignore:line
    } else { // noinspection JSUnresolvedVariable
        if (typeof module === 'object' && module.exports) { // jshint ignore:line
            // Node/CommonJS
            // noinspection JSUnresolvedVariable
            module.exports = factory(require('public/static/js/jquery')); // jshint ignore:line
        } else {
            // Browser globals
    ...
    $h = {
        ...
        closeButton: function (css) {
            ...
            return '<button style="display:none;" type="button" class="' + css + '" aria-label="Close">\n' +
