...
<div style="width:100%;height:100%;position:relative;margin:0 auto;zoom:1" id="context">
  <form id="form0" name="form0" eventProxy="Mform0" method="post" action="" style="margin:0px;position:relative;width:100%;height:100%;" enctype="application/x-www-form-urlencoded">
	...
	<input name="containerType" id="containerType" type="hidden" value="${param.containerType}"/><input name="containerType" id="containerType" type="hidden" value="${param.containerType}"/><input name="containerId" id="containerId" type="hidden" value="${param.containerId }"/>
	...
	<div id="content-main" class="tab-content" style="height:calc(100% - 32px);width:100%;border-color: #e7eaec;border-image: none;border-style: solid;border-width: 1px;border-top: 0px;">
		...
		<div class="tab-pane fade in active" id="TabPanel001" style='height:100%;padding: 3px 3px 0px 3px;'>
			<iframe class="J_iframe" src="<%=request.getContextPath()%>/editor/editor_getAssistEventDetailInfoById.action?entityId=${param.entityId}&flag=1&activityId=${param.activityId}&containerId=${param.containerId}&parentNodeId=${param.parentNodeId}&index=${param.index}" width="100%"  style='height:100%;border-width: 0px;'></iframe>
		</div>
		<div class="tab-pane fade" id="TabPanel002" style='height:100%;padding: 3px 3px 0px 3px;'>
			<iframe class="J_iframe"  src="<%=request.getContextPath()%>/editor/editor_getAssistUserDefinedPage.action?entityId=${param.entityId}&flag=2&activityId=${param.activityId}&containerId=${param.containerId}&parentNodeId=${param.parentNodeId}&index=${param.index}" width="100%" style='height:100%;border-width: 0px; display:block;'></iframe>
		</div>
	</div>
  </form>
</div>
