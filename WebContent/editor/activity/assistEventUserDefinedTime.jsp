...
<head>
	...
	<script type="text/javascript">
			...
			window.onblur = function(){
				...
				//发送请求保存自定义属性
				var url = "<%=request.getContextPath()%>/editor/editor_saveAssistEventUserDefinedProperty.action";
			...
			function openpopupSelectDialog302(){
				parent.parent.parent.openVariables1(this);     //loadBasicActivityTreeNodePage.jsp弹出
			}
			
			//打开动态变量值窗口
			function openpopupSelectDialog303(){
				parent.parent.parent.openVariables2(this);     //loadBasicActivityTreeNodePage.jsp弹出
			}
			
			//打开业务日历弹出窗口
			function openpopupSelectDialog301(){
				parent.parent.parent.openCalendar(this);       //loadBasicActivityTreeNodePage.jsp弹出
			}
