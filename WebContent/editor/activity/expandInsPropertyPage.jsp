...
<head>
	...
	function doubleClickSelect(record){
		if(record!=null){
			...
			parent.data = record;          //loadBasicActivityTreeNodePage.jsp记录data
	...
	function saveExtendProperties(){
		...
		if(data!=null && data.length>0){
			...
			var url = "<%=request.getContextPath()%>/editor/editor_saveExpandProperty.action";
						...
						<td colspan="2" style="border-style:none;width:100%;margin:0px;padding:0px;vertical-align: top;">
							...
							$(document).ready(function() {   
								$("#DataGrid001_table").bootstrapTable({           
									...
									url: "<%=path%>/editor/editor_getInsPropertyList.action", 
