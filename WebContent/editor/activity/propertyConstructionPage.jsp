		...
		<script type="text/javascript">
			...
			function forwardPageByNode1(node){
				...
				if(entityId=='jbxx'){//基本信息
					...
					parent.main_iframe1.src = "<%=request.getContextPath()%>/editor/editor_getCurActivityBasicInfo.action?entityId="+entityId+"&activityId="+activityId+"&custom="+custom+"&processType="+processType;
			...
			function refreshTreeNodeById(){
				...
				Matrix.forceFreshTreeNode("Tree001", parentNodeId);
			}
		</script>
</head>
<body>
...
<script>
 var MForm0=isc.MatrixForm.create({
 				...
 				position:"absolute",
 				//
 				action:"<%=request.getContextPath()%>/editor/editor_loadPropertyConstructTree.action",
 				fields:[{
...
<div type="hidden" id="Form0_hidden_text_div"
	...
	<table id="table001" class="tableLayout" style="width:100%;height:100%;">
		<tr id="tr105" name="tr105">
			<td id="td105" name="td105" style="width:100%;height:30px;background:#F8F8F8;"><font id="font1" style="font-size:14px;margin-left:10px;font-weight:bold;">属性结构</font></td>
		</tr>
		<tr id="tr001">
