...
<form id="form0" name="form0" eventProxy="Mform0" method="post" action="<%=request.getContextPath()%>/editor/process_getTypeDeclarations.action" style="margin: 0px; height: 100%;" enctype="application/x-www-form-urlencoded">
			...
			<td colspan="2" style="border-style:none;width:100%;margin:0px;padding:0px;vertical-align: top;">
				...
				$(document).ready(function() {   
					$("#DataGrid001_table").bootstrapTable({           
						...
						method: "post", 
						url: "<%=path%>/editor/process_getTypeDeclarations.action", 
						search: false, 
