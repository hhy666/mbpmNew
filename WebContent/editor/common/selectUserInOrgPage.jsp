...
<head>
		...
		function comfirmSelect(){
			debugger;
			var select = MTree0.getSelection();
...
<script>
 var Mform0=isc.MatrixForm.create({
 				...
 				name:"Mform0",
 				position:"absolute",
 				action:"<%=request.getContextPath()%>/processVersion_getUserInDep.action",
...
<form id="form0" name="form0" eventProxy="Mform0" method="post"
	...
	<script> isc.MatrixTree.create({	
								...
								root:{
									...
									text:"RootTreeNode",
									icon:"<%=request.getContextPath()%>/resource/images/matrix/org.png",
									type:0
								}	
						});
	...
	<tr id="tr002">
	<td id="td002" class="tdLayout" style="width:100%;height:32px;text-align:center;background-color:#F8F8F8;">
