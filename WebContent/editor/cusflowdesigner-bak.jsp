...
<style>
 ...
 function saveDiagramFromServer(){
	...
	function addActivity(){
        ...
        var top = parseInt((screen.availHeight/2) - (height/2)); 
        var windowFeatures = "width=" + width + ",height=" + height + ",status,resizable=no,left=" + left + ",top=" + top + "screenX=" + left + ",screenY=" + top;  
		//window.open('<%=request.getContextPath() %>/mobile/usersSelectPage.jsp?processType=<%=processType%>','选择加签人员',windowFeatures);
		window.open('<%=request.getContextPath() %>/mobile/flowEdit_loadActivityInfo.action?processType=<%=processType%>','选择加签人员',windowFeatures);
	}
...
<script>
	...
	function displayTransitionName(){
        ...
        <div id="editor" style="width: 100%; height:95%; " >
            ...
            <!--THE canvas-->
                <div  id="container" style="width: 100%; height:100%;display:none;"  onselectstart="return false">
                    <canvas id="a" >
