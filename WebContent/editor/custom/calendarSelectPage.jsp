	...
	<input name="version" id="version" type="hidden">
		...
		<script> var MDataGrid001_DS=<%=request.getAttribute("list")%>;
				isc.MatrixListGrid.create({
					...
					showAllRecords:true,
					fields:[
						{title:"编码",matrixCellId:"calendarId",name:"calendarId",canEdit:false,editorType:'InputHidden',type:'text'},
						{title:"名称",matrixCellId:"name",name:"name",canEdit:false,editorType:'Text',type:'text'}],
					autoSaveEdits:false,isMLoaded:false,autoDraw:false,autoFetchData:true,selectionType:"single",
					selectionAppearance:"rowStyle",alternateRecordStyles:true,showRollOver:true,
