...
<form id="Form0" name="Form0" eventProxy="MForm0" method="post"
	...
	<table id="table001" class="tableLayout" style="width:100%;">
		<tr id="tr111" name="tr111" >
			<td id="td111" class="tdLayout" style="width:20%;text-align:right;border-right:0px;background-color:#F8F8F8">
		 		<label id="label111" name="label111" style="padding-right:20px;">
					<font size="2" style="font-weight:bold">基本信息：</font>
				</label>
			</td>
			<td id="td112" class="tdLayout" style="width:80%;border-left:0px;background-color:#F8F8F8">
							...
							<div id='popupSelectDialog001_button_div' style='position:relative;width:100%;height:100%;vertical-align:middle;' class='matrixInline'>
								<script>isc.ImgButton.create({
										...
										MpopupSelectDialog001_button.click=function(){
											...
											MpopupSelectDialog001Dialog.setHeight("350px");
		...
		<tr id="tr112" name="tr112" >
			<td id="td113" class="tdLayout" style="width:20%;text-align:right;border-right:0px;background-color:#F8F8F8">
		 		<label id="label112" name="label112" style="padding-right:20px;">
					<font size="2" style="font-weight:bold">活动时限：</font>
				</label>
			</td>
			<td id="td113" class="tdLayout" style="width:80%;border-left:0px;background-color:#F8F8F8">
																...
																<td id="td333" class="tdLayout" colspan="8" rowspan="1" style="width:80%;">
																	...
																	<script> var McomboBox302_VM=[]; 
																			 var comboBox302=isc.SelectItem.create({
																			 			...
																			 			autoDraw:false,
																						value:'${activity.deadLineInfo.timeoutPolicy==""?"0":activity.deadLineInfo.timeoutPolicy=="UPGRADEPRIORITY"?"1":activity.deadLineInfo.timeoutPolicy=="SUBSTITUTE"?"2":activity.deadLineInfo.timeoutPolicy=="COMPLETE"?"3":"4"}',
																			 			valueMap:[],
																			 			position:"relative"});
		...
		<tr id="tr102" name="tr102">
			<td id="td102" name="td102" class="cmdLayout" style="width:100%;height:32px;text-align:center;line-height:25px;" colspan="2">
				<div id="button001_div" class="matrixInline" style="position:relative;;width:100px;;height:22px;">
					<script>
						...
						Mbutton001.click=function(){
							...
							var json = "{'priority':'"+priority+"','adid':'"+id+"','authId':'"+authId+"','authName':'"+authName+"','dateLine':'"+dateLine+"','unit':'"+unit+"','calendar':'"+calendar+"','calendarId':'"+calendarId+"','timeout':'"+timeoutStr+"'}";
