	...
	<script> 
		var MtabContainer0 = isc.TabSet.create({
				...
				tabBarControls : [
				 ...
				 tabs: [ 
				 	{
				 	title: "组织机构",pane:isc.HTMLPane.create({
				 	...
				 	title: "人员信息",pane:isc.HTMLPane.create({
...
document.getElementById('tabContainer0Bar0_div').appendChild(document.getElementById('tabContainer0Bar0_div2'));
	...
	MtabContainer0Panel0.setContentsURL('orgSelectUserPage.jsp');//nodeUuid传递参数
	MtabContainer0Panel3.setContentsURL('<%=request.getContextPath()%>/mobile/showUser_loadDataGridData.action?dataGridId=DataGrid004');//nodeUuid接收参数
