	...
	<table id="table101" name="table101" style="width:100%;height:100%;">
		<tr id="j_id2" jsId="j_id2">
			<td id="j_id3" jsId="j_id3"  height="60px"
				 style="height: 50px;width:100%;background-image:url(<%=request.getContextPath() %>/matrix/resource/images/probanner.jpg);">
						<br>
				...
				<table id="table102" name="table102" style="width:100%;height:100%;">
								...
								<tr id="tr106" name="tr106">
									<td id="td106" name="td106">
										...
										<div class="main" style="width:100%;height:100%;">
    										<iframe id="main_iframe" src="propertyConstructionTree1.jsp?type=${param.type }" style="width:100%;height:100%;" frameborder="0"></iframe>
    									</div>
					...
					<!-- 属性详细信息 -->
						<td id="td104" name="td104">
							...
							<div class="main" style="width:100%;height:100%;">
							<iframe id="main_iframe1"  style="width:100%;height:100%;" frameborder="0"></iframe>
