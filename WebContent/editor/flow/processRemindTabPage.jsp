  ...
  <form id="form0" name="form0" eventProxy="Mform0" method="post" action="" style="margin:0px;position:relative;width:100%;height:100%;" enctype="application/x-www-form-urlencoded">
	...
	<div id="content-main" class="tab-content" style="height:calc(100% - 32px);width:100%;border-color: #e7eaec;border-image: none;border-style: solid;border-width: 1px;border-top: 0px;">
		...
		<div class="tab-pane fade in active" id="TabPanel001" style='height:100%;padding: 3px 3px 0px 3px;'>
			<iframe class="J_iframe" src="<%=request.getContextPath()%>/editor/process_getProcessRemindInfoById.action?entityId=${param.entityId}&flag=1&index=${param.index}&parentNodeId=${param.parentNodeId}" width="100%"  style='height:100%;border-width: 0px;'></iframe>
		</div>
		<div class="tab-pane fade" id="TabPanel002" style='height:100%;padding: 3px 3px 0px 3px;'>
			<iframe class="J_iframe"  src="<%=request.getContextPath()%>/editor/process_getRemindUserDefinedPage.action?entityId=${param.entityId}&flag=2&index=${param.index}&parentNodeId=${param.parentNodeId}&isAssist=tx" width="100%" style='height:100%;border-width: 0px; display:block;'></iframe>
		</div>
	</div>
  </form>
</div>
