			    ...
			    <script type="text/javascript">
				    $(document).ready(function() {
		    			...
		    			$("#container").on("select_node.jstree",function(e, data){
		    				...
		    				var swimlineId = Matrix.getFormItemValue('swimlineId');
		    				...
		    				if(entityId=='jbxx'){		 //基本信息
		    					parent.document.getElementById('main_iframe1').src = "<%=request.getContextPath()%>/editor/editor_loadSwimLineBasicInfo.action?processdid="+processdid+"&type="+type+"&activityId="+activityId+"&containerId="+containerId+"&containerType="+containerType+"&swimlineId="+swimlineId;
		    				}
		    			}).jstree();
					});		
			    </script>
