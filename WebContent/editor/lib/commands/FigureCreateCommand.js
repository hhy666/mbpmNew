 ...
 */
function FigureCreateCommand(factoryFunction, x, y, figureId, status){
...
FigureCreateCommand.prototype = {
    ...
    execute : function(){
        if(this.firstExecute){
            ...
            var createdFigure = this.factoryFunction(this.x, this.y,this.figureId,this.status2);
            ...
            var type = createdFigure.oType;
            //initProperties(type,selectedFigureId);
            
			return createdFigure.id;
        }
        else{ //redo
