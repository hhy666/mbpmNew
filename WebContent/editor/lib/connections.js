...
var connector_defaultConnectorTextSize = 9;
...
*/
function Connector(startPoint,endPoint,type, id, name, status){
    /**Connector's id*/
    this.id = id;
    ...
    if(mode == "flow")
		this.middleText.setTextStr(this.name);
...
Connector.prototype = {
    ...
    updateName:function(name){
		this.name = name;
	    if(mode == "flow")
			this.middleText.setTextStr(name);
    }, 
    ...
    paint:function(context){
        ...
        switch(this.type){
            ...
            case Connector.TYPE_JAGGED:
                ...
                context.moveTo(this.turningPoints[0].x+0.5, this.turningPoints[0].y+0.5);
                ...
                for(var i=1; i< this.turningPoints.length; i++){
                    ...
                    if(this.startStyle == Connector.STYLE_EMPTY_TRIANGLE && i == 1){ //special case
                        ...
                        //move to new start
                        context.moveTo(newPoint.x+0.5, newPoint.y+0.5);
                    }
                    ...
                    if(this.endStyle == Connector.STYLE_EMPTY_TRIANGLE && i == this.turningPoints.length -1){ //special case 
                        ...
                        //line to new end
                        context.lineTo(newPoint.x+0.5, newPoint.y+0.5);
                    }
                    else{
                        context.lineTo(this.turningPoints[i].x+0.5, this.turningPoints[i].y+0.5);
                    }
                }
                context.stroke();
                break;
