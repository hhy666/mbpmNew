 ...
 * @author Alex
 */
function Container(id, topLeft, bottomRight, type, name) {
    /**Group's id*/
    if(id == null){
	...
	topLeft.x = topLeft.x+0.5;
	topLeft.y = topLeft.y+0.5;
	bottomRight.x = bottomRight.x+0.5;
	bottomRight.y = bottomRight.y+0.5;
	...
	if(type == "HSwimline"){
		...
		//HEADER
		var hBottomRight = new Point(this.topLeft.x + headerWidth, this.bottomRight.y);
	//    var roundness = 10;
		var roundness = 0;
		...
		var l1 = new Line(
				...
				new Point(this.topLeft.x, hBottomRight.y + roundness)
			);
		containerPath.addPrimitive(l1);
		var l2 = new Line(
				new Point(this.topLeft.x, hBottomRight.y + roundness),
				new Point(topLeft.x - roundness, this.topLeft.y)
			);
		containerPath.addPrimitive(l2);
	 
		var l3 = new Line(
				new Point(topLeft.x - roundness, this.topLeft.y),
				new Point(hBottomRight.x, topLeft.y)
			);
		containerPath.addPrimitive(l3);

		//BODY
		var l = new Line(
				new Point(this.topLeft.x+headerWidth, this.bottomRight.y),
				new Point(this.topLeft.x+headerWidth, this.topLeft.y)
			);
		containerPath.addPrimitive(l);
		
		l = new Line(
				new Point(this.topLeft.x+headerWidth, this.topLeft.y),
				new Point(this.bottomRight.x, this.topLeft.y - roundness)
			);
		containerPath.addPrimitive(l);
	    ...
	    var textY =  ((bottomRight.y-topLeft.y) - len*2)/2 ;
		
		title = new Text(titleValue, (this.topLeft.x + 20), this.topLeft.y + 25 +  textY /*@see https://bitbucket.org/scriptoid/diagramo/issue/31/text-vertical-aligment*/, Text.FONTS[0].Text, Text.DEFAULT_SIZE, false);
//		title = new Text(titleValue, (this.topLeft.x + 20), this.topLeft.y +70 + Text.DEFAULT_SIZE /*@see https://bitbucket.org/scriptoid/diagramo/issue/31/text-vertical-aligment*/, Text.FONTS[0].Text, Text.DEFAULT_SIZE, false);
	//    title.debug = true;
	...
	//    var roundness = 10;
		...
		if(name != null && name.length>0)
			titleValue = name;
		var title = new Text(titleValue, (this.topLeft.x + this.bottomRight.x)/2, this.topLeft.y +10 + Text.DEFAULT_SIZE /*@see https://bitbucket.org/scriptoid/diagramo/issue/31/text-vertical-aligment*/, Text.FONTS[0].Text, Text.DEFAULT_SIZE, false);
	//    title.debug = true;
		title.style.fillStyle = '#000000';
		this.addPrimitive(title);
