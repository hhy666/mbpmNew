...
<html>
	...
	<meta name="apple-mobile-web-app-status-bar-style" content="black">
        ...
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/assets/javascript/dropdownmenu.js"></script>    
        
        <link rel="stylesheet" media="screen" type="text/css" href="<%=request.getContextPath() %>/editor/assets/css/style.css" />
        <link rel="stylesheet" media="screen" type="text/css" href="<%=request.getContextPath() %>/editor/assets/css/minimap.css" />
        
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/assets/javascript/json2.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/assets/javascript/jquery-1.11.0.min.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/assets/javascript/ajaxfileupload.js"></script>
        ...
        <link type='text/css' href='<%=request.getContextPath() %>/editor/assets/simplemodal/css/diagramo.css' rel='stylesheet' media='screen' />
...
.demo-iframe-holder iframe {  
  ...
  width: 100%;  
        ...
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/assets/simplemodal/js/jquery.simplemodal.js"></script>
      <%
	    ...
	    if(selectedFigureId == '432375828421'){
	       ...
	       return;
			...
			var addcurPage = layer.open({
				...
				shadeClose: false, //开启遮罩关闭
				area : [ '90%', '90%' ],
				content : '<%=request.getContextPath() %>/office/html5/select/SingleSelectPerson.jsp?&iframewindowid=SlitAct&executeWay=split'
			});
	    ...
	    if(status == 3){  
	       ...
	       return;
			...
			var addactPage = layer.open({
				...
				content : '<%=request.getContextPath() %>/office/html5/select/SingleSelectPerson.jsp?iframewindowid=AddAct'
			});
...
//		parent.setPtid(ptid);
	...
	function onSlitActClose(info){
	  	var userIds = info.ids;
		var userNames = info.names;
		var executeWay = "split";
		
		var url="<%=request.getContextPath() %>/flow.dflow";
		var param="mode=custom&componentType=customAct&command=addActs&pdid=<%=pdid%>&containerType=process&preActId="+selectedFigureId+"&userIds="+userIds+"&userNames="+userNames+"&executeWay="+executeWay+"&piid="+piid;
	...
	function onAddActClose(info){
	  	var userIds = info.ids;
		var userNames = info.names;
		
		
		var url="<%=request.getContextPath() %>/flow.dflow";
		var param="mode=custom&componentType=customAct&command=addActs&pdid=<%=pdid%>&containerType=process&preActId="+selectedFigureId+"&userIds="+userIds+"&userNames="+userNames+"&piid="+piid;
		param = encodeURI(param);
		getUrlData(url,param,function(data){
			var data = eval('(' +data+ ')');
			var activities = data.activities;
	...
	function addActivityCallBack(info){
		...
		var url="<%=request.getContextPath() %>/flow.dflow";
		var param="mode=custom&componentType=customAct&command=addActs&pdid=<%=pdid%>&containerType=process&preActId="+selectedFigureId+"&userIds="+userIds+"&userNames="+userNames+"&executeWay="+executeWay;
		param = param +"&types="+types +"&authId="+authId+"&authName="+authName+"&isSetCalendar="+isSetCalendar+"&calendarId="+calendarId+"&duration="+duration+"&durationType="+durationType+"&piid="+piid;
		param = encodeURI(param);
		getUrlData(url,param,function(data){
			var data = eval('(' +data+ ')');
			var activities = data.activities;
	...
	function exit(){
		...
		if(piid != null && piid != ''){
			form0.action = "<%=request.getContextPath() %>/TextFlowForm.rform?mHtml5Flag=true&&pdid=defaultFlow&type=3&sysType=2&fromportal=1&adid=432375828421&authId=402881895668eada015668ffed6d0003";
		}else{
			form0.action = "<%=request.getContextPath() %>/TextFlowStartForm.rform?mHtml5Flag=true&pdid=defaultFlow&type=3&sysType=2&fromportal=1&adid=432375828421&authId=402881895668eada015668ffed6d0003";
		}
		form0.submit();
	}
	...
	var scale = parseFloat("1");
        ...
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/canvasprops.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/style.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/primitives.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/ImageFrame.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/matrix.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/util.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/key.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/groups.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/stack.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/connections.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/connectionManagers.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/handles.js"></script>
        
        
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/builder.js"></script>        
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/text.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/log.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/text.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/browserReady.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/containers.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/importer.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/main.js"></script>
        
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/sets/basic/basic.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/sets/flow/flow.js" charset="UTF-8" ></script>
        
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/minimap.js"></script>

        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/commands/History.js"></script>

        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/commands/FigureCreateCommand.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/commands/FigureCloneCommand.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/commands/FigureTranslateCommand.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/commands/FigureRotateCommand.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/commands/FigureScaleCommand.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/commands/FigureZOrderCommand.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/commands/FigureDeleteCommand.js"></script>
        
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/commands/GroupRotateCommand.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/commands/GroupScaleCommand.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/commands/GroupCreateCommand.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/commands/GroupCloneCommand.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/commands/GroupDestroyCommand.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/commands/GroupDeleteCommand.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/commands/GroupTranslateCommand.js"></script>
        
        
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/commands/ContainerCreateCommand.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/commands/ContainerDeleteCommand.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/commands/ContainerTranslateCommand.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/commands/ContainerScaleCommand.js"></script>
        
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/commands/ConnectorCreateCommand.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/commands/ConnectorDeleteCommand.js"></script>                                
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/commands/ConnectorAlterCommand.js"></script>
        
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/commands/ShapeChangePropertyCommand.js"></script>
        
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/commands/CanvasChangeColorCommand.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/commands/CanvasChangeSizeCommand.js"></script>

        <script type="text/javascript" src="<%=request.getContextPath() %>/editor/lib/commands/InsertedImageFigureCreateCommand.js"></script>
...
<br>
        <div id="actions">
            ...
            <a href="javascript:addActivity();"  title="加签"><img src="assets/images/add.png" style="height:24px;" border="0"/></a>

            <img class="separator" src="assets/images/toolbar_separator.gif" border="0" width="1" height="16"/>
            
 			<a href="javascript:addCurActParallel();"  title="当前会签"><img src="assets/images/vertical_distribute.png" style="height:24px;" border="0"/></a>

            <img class="separator" src="assets/images/toolbar_separator.gif" border="0" width="1" height="16"/>
                        
            <a href="javascript:deleteActivity();" title="减签"><img src="assets/images/delete.png" style="height:24px;" border="0"/></a>
            
            <img class="separator" src="assets/images/toolbar_separator.gif" border="0" width="1" height="16"/>
            
            <a href="javascript:exit();" title="退出"><img src="assets/images/exit.png" border="0" style="height:24px;" alt="退出"/></a>
...
<form id="form0" name="form0" method="post">
      <input type="hidden" id="ckeditorContent" name="ckeditorContent" value="<%=request.getParameter("ckeditorContent") %>"/>
      <input type="hidden" id="pdid" name="pdid" value="<%=request.getParameter("pdid") %>"/>
      <input type="hidden" id="ptid" name="ptid" value="<%=request.getParameter("ptid") %>"/>
      <input type="hidden" id="piid" name="piid" value="<%=request.getParameter("piid") %>"/>
      <input type="hidden" id="atid" name="atid" value="<%=request.getParameter("atid") %>"/>
      <input type="hidden" id="adid" name="adid" value="<%=request.getParameter("adid") %>"/>
      <input type="hidden" id="aiid" name="aiid" value="<%=request.getParameter("aiid") %>"/>
      <input type="hidden" id="taskId" name="taskId" value="<%=request.getParameter("taskId") %>"/>
      <input type="hidden" id="mFlowBizId" name="mFlowBizId" value="<%=request.getParameter("mFlowBizId") %>"/>
      <input type="hidden" id="plateId" name="plateId" value="<%=request.getParameter("plateId") %>"/>
      
      <input type="hidden" id="mHtml5Flag" name="mHtml5Flag" value="true"/>
      <input type="hidden" id="type" name="type" value="3"/>
      <input type="hidden" id="fromportal" name="fromportal" value="1"/>
      <input type="hidden" id="authId" name="authId" value="402881895668eada015668ffed6d0003"/>
      
      <input type="hidden" id="p_title" name="p_title" value="<%=request.getParameter("p_title") %>"/>
        <div id="editor" style="width: 100%; height:95%; " >
            
            <!--THE canvas-->
                <div  class="" id="container" style="width: 100%; height:80%;display:none;-webkit-overflow-scrolling : touch; "  onselectstart="return false">
                    <canvas  class="scroll-wrapper" id="a" >
