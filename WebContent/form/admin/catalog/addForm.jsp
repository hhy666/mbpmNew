...
<script> 
	var MForm0=isc.MatrixForm.create({
		...
		name:"MForm0",
		position:"absolute",
		action:"catalog_addComponent.action",
		fields:[{
...
<form id="Form0" name="Form0" eventProxy="MForm0" method="post"  action="catalog_addComponent.action"
...
<div style="text-valign: center; position: relative">		
  <table id="j_id3" jsId="j_id3" class="maintain_form_content" style="width:100%">
	<tr id="j_id4" jsId="j_id4">
		...
		<div id="mid_div" eventProxy="MForm0" class="matrixInline matrixInlineIE" style="float:left;"></div>
		<script>
	...
	<tr id="j_id9" jsId="j_id9">
		...
		<div id="name_div" eventProxy="MForm0" class="matrixInline matrixInlineIE" style="float:left;"></div>
		<script> 
