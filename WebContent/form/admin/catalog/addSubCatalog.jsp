...
// 发送异步请求
function vertifyInfo(form,content,callbackFun,errorFun,method){
	if(form==null){
		return;
	}
...
<form id="Form0" name="Form0" eventProxy="MForm0" method="post"
	action="<%=request.getContextPath()%>/catalog_addSubCatalog.action" style="margin: 0px; height: 100%;"
...
<script>Matrix.appendChild('j_id2_div','j_id2_div2');</script>
	...
	<input id="createdUser" type="hidden" name="createdUser" value=""/>
	...
	<input type="hidden" name='publicValue' id='publicValue'value="${catalogNode.isPublic }"/>
	<input id="parentNodeId" type="hidden" name="parentNodeId" value="${param.parentNodeId}"/>
	<input id='dataGridData' type='hidden' name='dataGridData' value=""/>
</div>
