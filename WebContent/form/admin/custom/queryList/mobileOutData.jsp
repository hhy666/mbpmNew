	...
	fields:[{name:'form0_hidden_text',
		...
		<div
			...
			<form id="form0" name="form0" eventProxy="Mform0" method="post"
				...
				<table id="table101" name="table101"
								...
								<tr>
									...
									<td id="td103" name="td103" style="width: 30%;">
										<div class="main" style="width: 100%; height: 100%;">
											<iframe id="main_iframe" src="<%=request.getContextPath()%>/form/admin/custom/queryList/tabPage.jsp?formId=${param.formId}&flag=${param.flag}"
...
window.onload=function(){
				...
				var selectedItems = MDataGrid005.getData();
		if(selectedItems==null || selectedItems.size()==0){
				if(parent.parent.showMobileListName!=null&&parent.parent.showMobileListName.length>0){
					var a = JSON.stringify(parent.parent.showMobileListName);
					var b = JSON.parse(a);
