...
var flag=false;
	window.onload=function(){
				debugger;
if(parent.parent.hignCondition!=null&&parent.parent.hignCondition.length>0){
		var a = JSON.stringify(parent.parent.hignCondition);
		var b = JSON.parse(a);
						...
						<!-- 标签页  机构/人员/角色 -->
							<td id="td103" name="td103" style="width:41%;">
								<div class="main" style="width:100%;height:100%;">
	    							<iframe id="main_iframe" src="tabSenior.jsp?formId=${param.formId}&flag=${param.flag}" style="width:100%;height:100%;" frameborder="0"></iframe>
	    						</div>
							</td>
