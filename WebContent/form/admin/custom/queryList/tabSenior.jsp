...
<div id="tabContainer0Bar0_div2" style="text-align: right;width:50%;" class="matrixInline"></div>
<script>
	document.getElementById('tabContainer0Bar0_div').appendChild(document.getElementById('tabContainer0Bar0_div2'));
	MtabContainer0Panel3.setContentsURL('<%=request.getContextPath()%>/query/form_queryFormlist.action?formId=${param.formId}&flag=${param.flag}&operation=true');
