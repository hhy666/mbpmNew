...
var flag=false;
	window.onload=function(){
				debugger;
if(parent.parent.userInputCondition!=null&&parent.parent.userInputCondition.length>0){
		var a = JSON.stringify(parent.parent.userInputCondition);
		var b = JSON.parse(a);
	...
	function comfirmSelect(){
	   debugger;
		...
		parent.parent.parent.parent.userInputCondition=[];
...
<form id="form0" name="form0" eventProxy="Mform0" method="post" action="" style="margin:0px;position:relative;overflow:auto;width:100%;height:100%;" enctype="application/x-www-form-urlencoded">
						...
						<!-- 标签页  机构/人员/角色 -->
							<td id="td103" name="td103" style="width:41%;">
								<div class="main" style="width:100%;height:100%;">
	    							<iframe id="main_iframe" src="tabTerm.jsp?mBizId=${param.mBizId}&formId=${param.formId}" style="width:100%;height:100%;" frameborder="0"></iframe>
	    						</div>
							</td>
	...
	<tr><td colspan="2" style="border-style:none;width:100%;margin:0px;padding:0px;height:94%"><div id="DataGrid005_div" class="matrixComponentDiv" style="width:100%;height:100%;">
					...
					var displayValueMap = {'equal':'等于','greater':'大于','greaterOrEqual':'大于等于','smaller':'小于','smallerOrEqual':'小于等于','notEqual':'不等于','%like':'前匹配查询','like%':'后匹配查询','like':'模糊查询','in':'在之内'};
					isc.MatrixListGrid.create({
						...
						{title : "操作符",matrixCellId : "operator",name : "operator",canEdit : true,editorType : 'select',type : 'text',valueMap:{'equal':'等于','greater':'大于','greaterOrEqual':'大于等于','smaller':'小于','smallerOrEqual':'小于等于','notEqual':'不等于','%like':'前匹配查询','like%':'后匹配查询','like':'模糊查询','in':'在之内'},
						editorProperties:{
						...
						{title:"",name:"userName",type:'text',editorType:'Text'}
