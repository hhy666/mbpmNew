...
debugger;
   ...
   //		var node = $('#container',window.parent.document).jstree('get_node','root');
	//	$('#container',window.parent.document).jstree(true).refresh_node(node);
		var nodeId = parent.$('#container').jstree(true).get_selected();
   		parent.$('#container').jstree("refresh_node",nodeId);
