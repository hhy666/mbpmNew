	...
	<script> var MtabContainer0 = isc.TabSet.create({ID:"MtabContainer0",displayId:"tabContainer0_div",layoutTopMargin:0,
	   height: "98%",width: "100%",position: "relative",align: "center",tabBarPosition: "top",tabBarAlign: "left",showPaneContainerEdges: false,showTabPicker: true,showTabScroller: true,
		...
		tabs: [ 
			...
			contentsURL:"<%=request.getContextPath()%>/form.daction?componentType=DataGrid&componentId=${param.componentId}&command=editPart&page=basic&mode=propertyedit"})}
			...
			contentsURL:"<%=request.getContextPath()%>/form/admin/designer/composite/ListDataFields.jsp"})}
			...
			contentsURL:"<%=request.getContextPath()%>/form.daction?componentId=${param.componentId}&command=editPart&page=advance&mode=propertyedit&componentType=DataGrid"})}
			  ] });
