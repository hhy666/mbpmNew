	...
	<script> var MtabContainer0 = isc.TabSet.create({ID:"MtabContainer0",displayId:"tabContainer0_div",layoutTopMargin:0,
	   height: "100%",width: "100%",position: "relative",align: "center",tabBarPosition: "top",tabBarAlign: "left",showPaneContainerEdges: false,showTabPicker: true,showTabScroller: true,
		...
		tabs: [ 
			...
			contentsURL:"<%=request.getContextPath()%>/form.daction?componentType=DataView&componentId=${param.componentId}&command=editPart&page=basic&mode=propertyedit"})}
			,{title: "数据项",pane:isc.HTMLPane.create({ID:"MtabContainer0Panel1",height: "100%",overflow: "hidden",margin:0,autoDraw: false,showEdges:false,contentsType:"page",
			contentsURL:"<%=request.getContextPath()%>/form/admin/designer/composite/ViewDataFields.jsp"})}
			...
			contentsURL:"<%=request.getContextPath()%>/form.daction?componentId=${param.componentId}&command=editPart&page=advance&mode=propertyedit&componentType=DataView"})}
			  ] });
