...
%>
		...
		<table style="border-collapse: collapse;border-spacing:0px;height:100%;width:100%;table-layoug:fixed;">
				...
				<td style="width: 160px;overflow:hidden;height:100%;">
					<table style="border-collapse:collapse;border-spacing:0px;border:0;height: 100%; width: 100%;">
						<tr><td style="height:50px;background-image: url(<%= request . getContextPath() %>/matrix/resource/images/queryview/title.jpg);"></td></tr>
						<tr><td style="background-image: url(<%= request . getContextPath() %>/matrix/resource/images/queryview/bg.jpg);"></td></tr>
						<tr><td style="height:200px;background-image: url(<%= request . getContextPath() %>/matrix/resource/images/queryview/logo.jpg);"></td></tr>
					</table>
				</td>
                        <td >
                            <iframe id="iframe1" height="100%" width="100%" frameborder="0" src="<%=request.getContextPath() %>/form.daction?componentType=QueryView&command=editPart&page=first&mode=propertyedit">
                            </iframe>
                        </td>
                    </tr>
             </table>
	...
	<tr>
		<td style="height:28px">
			...
			Matrix.showMask();
			document.getElementById('Form0').action="<%=request.getContextPath()%>/form/admin/designer/composite/queryViewInfo.jsp";
