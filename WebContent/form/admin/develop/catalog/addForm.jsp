...
<script> 
	var MForm0=isc.MatrixForm.create({
		...
		name:"MForm0",
		position:"absolute",
		action:"<%=request.getContextPath()%>/dcatalog/catalogAction_addComponent.action",
		fields:[{
...
<form id="Form0" name="Form0" eventProxy="MForm0" method="post"  action="<%=request.getContextPath()%>/dcatalog/catalogAction_addComponent.action"
  ...
  <table id="j_id3" jsId="j_id3" class="maintain_form_content" style="width:100%">
	<tr id="j_id4" jsId="j_id4">
		<td id="j_id5" jsId="j_id5" class="maintain_form_label" colspan="1"
			rowspan="1" style="text-align: center; width: '20%'"><label
	...
	<input id="entityPath" type="hidden" name="entityPath" value="${catalogNode.subItems}"/>
	<input id="parentId" type="hidden" name="parentId" value="${requestScope.parentId}" />
