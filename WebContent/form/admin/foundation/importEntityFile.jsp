        ...
        <div id="j_id1" jsId="j_id1" style="position:relative;_layout:flowlayout;width:100%;height:100%">
            <script>
                var MForm0 = isc.MatrixForm.create({
                    ...
                    name: "MForm0",
                    position: "absolute",
                    action: "<%=request.getContextPath() %>/file/importfile?importType=entity",
            ...
            <form id="Form0" name="Form0" eventProxy="MForm0" method="post" action="<%=request.getContextPath() %>/file/importfile?importType=entity"
            style="margin:0px;height:100%;" enctype="multipart/form-data">
               ...
               <input id="type" name="type" type="hidden" value="test" />
                ...
                style="position:absolute;width:0;height:0;z-index:-9999999999;top:0;left:0;display:none;">
                    ...
                    <div id="j_id2_div2" style="width:100%;height:100%;overflow:auto;" class="matrixInline">
                        <table id="j_id3" jsId="j_id3" class="maintain_form_content">
                            <tr id="j_id24" jsId="j_id24" >
                                <td id="j_id25" jsId="j_id25" class="maintain_form_label" colspan="1" rowspan="1">
                                    <label id="j_id26" name="j_id26" style="margin-left:10px">
                                        数据格式：
                                    </label>
                                </td>
                                <td id="j_id27" jsId="j_id27" class="maintain_form_input"  colspan="1" rowspan="1">
                                ...
                                <td id="j_id7" jsId="j_id7" class="maintain_form_input"  colspan="1" rowspan="1">
                                    <script>
                                        ...
                                        function validateUploadFile(vId) {
                                            ...
                                            var dataType = Matrix.getFormItemValue('comboBox002');
                                            
                                            if ( !(dataType == 'new' && Matrix.validateUploadFileType(vId, UploadFile0_file_annexType))
                                            		&& !(dataType == 'old' && Matrix.validateUploadFileType(vId, 'ds'))) {
                                           		 isTrueType = false;
			...
			icon:Matrix.getActionIcon("save"),
                                            ...
                                            MdataFormSubmitButton.click = function() {
                                              ...
                                              var action = "<%=request.getContextPath() %>/file/importfile?importType=entity";
                                              action = action +"&dataType="+Matrix.getFormItemValue('comboBox002');
