        ...
        <div id="j_id1" jsId="j_id1" style="position:relative;_layout:flowlayout;width:100%;height:100%">
            <script>
                var MForm0 = isc.MatrixForm.create({
                    ...
                    name: "MForm0",
                    position: "absolute",
                    action: "<%=request.getContextPath() %>/file/importfile?importType=formModel",
            ...
            <form id="Form0" name="Form0" eventProxy="MForm0" method="post" action="<%=request.getContextPath() %>/file/importfile?importType=formModel"
                        ...
                        <table id="j_id3" jsId="j_id3" class="maintain_form_content" style="height:100%;">
                        	<tr>
                        		<td colSpan="2" style="height:20px;">
									...
									<%}%>
                        			<span style="color:red;">*选择xml类型的表单模型文件进行导入</span>
                        		</td>
                        	</tr>
                                    ...
                                    <div id="dataFormCancelButton_div" class="matrixInline matrixInlineIE" style="position:relative;;width:100px;;height:22px;">
                                        <script>
                                            ...
                                            MdataFormCancelButton.click = function() {
                                                parent.isc.MH.cancelImportFormXML();
                                            };
                                        </script>
                                    </div>
                                </td>
