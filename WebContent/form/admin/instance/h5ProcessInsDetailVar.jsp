...
<body>
	<form id="Form0" name="Form0" method="post"	action="" style="margin: 0px; height: 500px;" enctype="application/x-www-form-urlencoded">
		...
		<input type="hidden" id="processData" name="processData" value="${processData}" />
    			...
    			<script>
   	    			$(document).ready(function(){
						...
						$("#DataGrid001_table").bootstrapTable({
							...
							url:'<%=path%>/instance/processInstance_h5GetProcessInsVar.action',
							search: false, 
					        ...
					        queryParams: function(params){
					        	var temp = {
				        			processData : document.getElementById('processData').value,
					        	}
					        	return temp;
					        },
