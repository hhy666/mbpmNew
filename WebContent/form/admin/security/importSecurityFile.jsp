...
<html>
	...
	//导入权限
	function importFile(){
			var formUuid = Matrix.getFormItemValue('recordId');
			var formName = Matrix.getFormItemValue('formName');
		    var flag = "importDoc";
    ...
    <body>
       <jsp:include page="/form/admin/common/loading.jsp"/>
        <div id="j_id1" jsId="j_id1" style="position:relative;_layout:flowlayout;width:100%;height:100%">
            ...
            <input type="hidden" name="formName" id="formName" value="${param.formName }"/>
