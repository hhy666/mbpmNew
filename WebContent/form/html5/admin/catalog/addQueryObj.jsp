...
名称：</label></td>
<td id="td004" class="tdLayout" style="width:60%;"><div id="input002_div" class="input-group col-md-12 " style="display: inline-table; vertical-align: middle; width:80%; "> <input id="name" name="name"  required type="text" class="form-control " style=" width:100%;height:100%;padding-left: 5px;" autocomplete="off" value=${catalogNode.name } >
 </div>
 <font id="namefont" color="red" >${nameEchoMessage }</font>
 </td>
</tr>
<tr id="tr004"><td id="td008" class="tdLayout" style="width:40%;text-align:center;vertical-align:middle;background-color:rgb(248, 248, 248)"><label id="label004" name="label004" id="label004" class="control-label ">
启用状态：</label></td>
<td id="td009" class="tdLayout" style="width:60%;"><div id="input003_div" class="input-group col-md-12 " style="display: inline-table; vertical-align: middle; width:80%; "> 
<select class="form-control js-states" id="State" name="state" tabindex="-1" style=" width:100%;height:100%;"  >
<option value="1" 
<%
