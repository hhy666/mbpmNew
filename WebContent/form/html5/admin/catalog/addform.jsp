...
编码：</label></td>
<td id="td002" class="tdLayout" style="width:60%;"><div id="input001_div" class="input-group col-md-12 " style="display: inline-table; vertical-align: middle; width:80%; "> <input id="mid" name="mid" type="text" required class="form-control " style=" width:100%;height:100%;padding-left: 5px;" autocomplete="off" > </div>
...
名称：</label></td>
<td id="td004" class="tdLayout" style="width:60%;"><div id="input002_div" class="input-group col-md-12 " style="display: inline-table; vertical-align: middle; width:80%; "> <input id="name" name="name" type="text" class="form-control "  required style=" width:100%;height:100%;padding-left: 5px;" autocomplete="off" >
 </div>
...
<tr id="tr007">
	...
	<td class="tdLayout" style="width: 100%;">
		<div id="layoutType_div" style="vertical-align: middle;">
			<select id="layoutType" name="layoutType" class="form-control" style="height:100%;width:80%;">                  
...
备注：</label></td>
<td id="td006" class="tdLayout" style="width:60%;"><div id="inputTextArea001_div" class="col-md-12 input-group " style="width:100%; "> <textarea id="desc" name="desc" " class="form-control " style=" width:100%;height:100%;" ></textarea></div></td>
</tr>
<tr id="tr004" ><td id="td007" class="cmdLayout" colspan="2" rowspan="1" >
	...
	<input id="isComposite" type="hidden" name="isComposite" value="${param.isComposite }" >
	<input id="childForm" type="hidden" name="childForm" value="${param.childForm }">
	<script>
