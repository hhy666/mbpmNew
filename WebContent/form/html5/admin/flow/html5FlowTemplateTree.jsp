...
<body>
		<div id="col1" class="" style="height:100%; padding: 0px;border-right: inset;border-right-width: 1px;">
					...
					<script type="text/javascript">
						...
						$(document).ready(function() {
			    			...
			    			<%-- $("#container").on("select_node.jstree",function(e, data){
								...
								if(thetype == 2){
									document.getElementById('InfoIframe').src="<%=request.getContextPath()%>/matrix.rform?configUUID="+uuid+"&formId="+formId+"&mIsQueryMode=false";
								}
			    			}).jstree(); --%>
						});
					</script>
