						...
						$(document).ready(function() {
							...
							var tree=	$('#container').jstree({
								'core' : {
				    				...
				    				'data' : {
										"url" : '<%=path %>/common/html5Common_designChooseCommonTree.action',
										//	function(node){
			    			...
			    			$('#container').on('dblclick.jstree', function(e, datas) {
			    				...
			    				if(type==16){
			    					var data = {};
				    				data.proEntityType = original.proEntityType;
				    				Matrix.closeWindow(data);
			    				}else{
			    					layer.alert("请选择实体！");
			    				}
			    				//parent.onDialog0Close(data);
				...
				<script>
					$('#button001').click(function(data){
						...
						if(selected.length == 1){
			    				...
			    				if(type==16){
				    				var data = {};
				    				data.proEntityType = node.original.proEntityType;
				    				Matrix.closeWindow(data);
			    				}else{
			    					layer.alert("请选择实体！");
			    				}
