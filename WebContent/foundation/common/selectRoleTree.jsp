...
<script type="text/javascript">
     ...
     function submitByButton(){
	    ...
	    if(nodeDataValue!=null&&nodeDataValue.length>0){
	      ...
	      isc.say("请选择角色!",{width:150,height:70});
	    }
...
<script> 
	var MForm0=isc.MatrixForm.create({
				...
				name:"MForm0",
				position:"absolute",
				action:"<%=request.getContextPath()%>/common/roleSelected_getSubRolesForTree.action",
				fields:[{
		  ...
		  if(node.type==0){ //根节点
		     // return Matrix.getTreeNodeIcon("root");
		      return isc.Page.getImgURL("http://localhost:9090/demo/resource/isomorphic/skins/Enterprise/images/matrix/tree/folder.png");
		  	  ...
		  	  //return Matrix.getTreeNodeIcon("rolecatalog");
		  	  return isc.Page.getImgURL("http://localhost:9090/demo/resource/isomorphic/skins/Enterprise/images/matrix/tree/folder.png");
		  }else if(node.isFolder ==false){//角色
		  	//return Matrix.getTreeNodeIcon("role");
		  	return isc.Page.getImgURL("http://localhost:9090/demo/resource/isomorphic/skins/Enterprise/images/matrix/tree/role.png");
		  }
		}
	});
