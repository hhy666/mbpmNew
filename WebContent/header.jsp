...
<%
com.matrix.api.MFExecutionService service = (com.matrix.api.MFExecutionService)session.getAttribute(com.matrix.client.ClientConstants.EXECUTION_SERVICE);
	String userName = service.getMFUser().getUserName();
%>
...
<script>
	...
	function getFunctionItems(){
		...
		items.add(
	        isc.VLayout.create({
			      ...
			      backgroundImage:"[SKIN]/matrix/user/matrix/header_bg.png",
	              members:[
	                         isc.Label.create({align: "right", height:20,contents:'欢迎您 Welcome，'+"<%=userName%>"+"&nbsp;&nbsp;"}),
	...
	//注销
	function logoff(){
		top.location="/moffice/logoffAction_logoff.action";
	}
