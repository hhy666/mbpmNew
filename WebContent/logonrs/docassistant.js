...
function clsStandardTableCtrl$initAdd()
{
    ...
    jsonCondData.pageNum = this.jsonData.pageNum+1;
    ...
    if (this.ctrl.data == null) {
        ...
        $.ajax({
            ...
            success: function (data) {
                var jsonData = JSON.parse(data);
                if (jsonData.retCode == "0000000") {
                    this.ctrl.jsCtrl.jsonData = jsonData.rspBody;
                    this.ctrl.jsCtrl.jsonFData = jsonData;
...
function clsOtherCtrl$getValue(key, type) {
    return (type == null) ? $(this.ctrl).val() : this.ctrl.jsonData;
}
