...
if(devmodel){
    //开发模式地址
    lctitleUrl = 'http://10.3.59.209:8052/mbpm2/ViewForm.rform'
    lcUrl = 'http://10.3.59.209:8052/mbpm2/CreateSynProcess.rform';
    taskUrl = 'http://10.3.59.209:8052/mbpm2/MyCoorUndoTasks.rform';
    beReadyUrl = 'http://10.3.59.209:8052/mbpm2/MyCoorCompletedTasks.rform';
}else{
    //正式模式地址
    lctitleUrl = 'http://10.188.56.40/mbpm/ViewForm.rform'
    lcUrl ='http://10.188.56.40/mbpm/CreateSynProcess.rform';
    taskUrl = 'http://gxh.sgjtsteel.com/mbpm/MyCoorUndoTasks.rform';
    beReadyUrl = 'http://gxh.sgjtsteel.com/mbpm/MyCoorCompletedTasks.rform';
}
/*****************************增值测试地址*************************************/
    ...
    if(status != null)
    {
        ...
        switch(status)
        {
            ...
            /* case "999999":
                 ...
                 break;*/
            case "0200000":
                window.location.href="/sgjtQTI/pages/login/beforlogin/html-gulp-www/beforlogin.html";
                break;
            default:
...
//         $("#headerLoad").load("/pages/common/html-www/commonHeader.html");
//     }
