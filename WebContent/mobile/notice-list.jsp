    ...
    <div class="mui-off-canvas-wrap mui-draggable " id="offCanvasWrapper">
		...
		<div class="mui-content">
		 <header class="mui-bar mui-bar-nav">
                ...
                <h1 id="title" class="mui-title">公告栏目</h1>
                 <script type="text/javascript">
					//返回按钮点击事件
						document.getElementById('backIcon').addEventListener('tap', function() {
							...
							if(type == "notice"){    //公告列表
								window.location.href = '<%=request.getContextPath() %>/mobile/notice-inlet.jsp?type=noticecolumn';
							}else if(type == "catalog"){   //公告栏目
  ...
  <span class="mui-number">1/2</span>
		...
		<script>
		   ...
		   function initParam(){
	   	      ...
	   	      if(type == "notice"){
				document.getElementById("title").innerText="公告列表";
	   	      }else if(type == "catalog"){
				document.getElementById("title").innerText="公告栏目";
	   	      }
		   }
		   ...
		   window.onload = initParam();
			...
			function noticeList(catalogId){
				type = "notice";
//				document.getElementById("title").innerText="å¬ååè¡¨";
				parentId = catalogId;
				clearData();
				loadData();
			}
...
//					data["queryStartNum"] = startNum * matrix.DEFAULT_PAGE_SIZE + 1;
					...
					matrix.sendRequest("<%=request.getContextPath()%>/mobile/notice_queryNotices.action",data,loadDataCallback);
