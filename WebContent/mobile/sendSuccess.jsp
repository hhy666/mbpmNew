...
<script>
		...
		//返回按钮点击事件
			document.getElementById('backIcon').addEventListener('tap', function() {
					//window.location.href = '<%=request.getContextPath() %>/mobile/app-list.jsp?type=newApp&parentId=flowRoot';
				window.location.href = '<%=request.getContextPath() %>/mobile/apply_query.action';
			});
		  } 
		</script>
			...
			<div class="mui-content">
				...
				<div id="datalist" class="mui-content mui-scroll-wrapper"
					...
					<div id="contentDiv" class="iframeDiv" style='margin-top:50px;'>
						<img alt="" src="<%=request.getContextPath() %>/resource/mobile/Bitmap.png">
