    ...
    <div class="mui-off-canvas-wrap mui-draggable " id="offCanvasWrapper">
		...
		<div class="mui-content">
		 <header class="mui-bar mui-bar-nav">
                ...
                <h1 id="title" class="mui-title">调查栏目</h1>
                <script type="text/javascript">
					...
					document.getElementById('backIcon').addEventListener('tap', function() {
						...
						if(type == "survery"){    //调查列表
							window.location.href = '<%=request.getContextPath() %>/mobile/survery-inlet.jsp?type=surverycolumn';
						}else if(type == "catalog"){   //调查栏目
		...
		<script>
		  ...
		  var parentId = "";
		   function initParam(){
				...
				document.getElementById("title").innerText="调查栏目";
	   	      }
		   ...
		   window.onload = initParam();
			...
			function surveryList(catalogId){
				type = "news";
				document.getElementById("title").innerText="调查列表";
				parentId = catalogId;
				clearData();
			...
			function loadData(){
				...
				if(dataType=="catalog"){
					...
					matrix.sendRequest("<%=request.getContextPath()%>/mobile/survery_querySurvery.action",data,loadDataCallback);
