...
<script>
		  ...
		  window.onload=function(){
			  debugger;
			  var flag = "${param.flag}";
		      if(flag == 'save'){   //如果点的是保存按钮
 		    	  document.getElementById('contentDiv').innerHTML = "<img src=\"<%=request.getContextPath() %>/resource/mobile/Bitmap.png\"><div style=\"font-family: PingFangSC-Regular;font-size: 24px;color: #000000;letter-spacing: 0.78px;\">保存成功！</div>";
		      }
		      //返回按钮点击事件
			...
			<div class="mui-content">
				...
				<div id="datalist" class="mui-content mui-scroll-wrapper"
					...
					<div id="contentDiv" class="iframeDiv" style='margin-top:50px;'>
						<img src="<%=request.getContextPath() %>/resource/mobile/Bitmap.png">
