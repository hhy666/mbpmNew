...
    }
		...
		var src = "<%=request.getContextPath()%>/office/countMeeting/tabjoin.jsp?userId="+userId+"&userName="+userName+"&type="+type+"&startTime="+startTime+"&endTime="+endTime;
	...
	isc.VLayout.create( {
		...
		members : [ isc.MatrixHTMLFlow.create( {
			...
			contentsType : "page",
				contentsURL : "<%=request.getContextPath()%>/office/countMeeting/tabjoin.jsp?userId=&userName=&type=&startTime=&endTime="
		}) ],
		canSelectText : true
	});
</script>
