...
<head>
	...
	<script type="text/javascript">
		...
		function searchItems3(){
			...
			$('#rightselect').find('li').each(function() {
				if(keyword && $(this).text().indexOf(keyword) >= 0){
					$(this).addClass("changeColor");
				}else{
		...
		<div class="select-pane">
			<div class="pane-left">
				...
				<div class="role-pane" style="display: none;">
					...
					<div class="input-group">
						<input id="userKeyWordByRole" name="userKeyWordByRole" type="text" class="form-control" style="height:30px;" onkeydown="if(event.keyCode == 13)searchUserByRole()" placeholder="请输入用户名称或工号" data-i18n-placeholder="请输入用户名称或工号">
				...
				<div class="person-pane" style="display: none;">
					<div class="input-group">
						<input id="q" name="q" type="text" class="form-control" style="height:30px;" onkeydown="if(event.keyCode == 13)searchItems()" placeholder="请输入人员名称或工号" data-i18n-placeholder="请输入用户名称或工号">
			...
			<div class="pane-right">
				<div id="personResult" class="input-group" style="display: none;">
					<input id="q3" name="q3" type="text" class="form-control" style="height:30px;" onkeydown="if(event.keyCode == 13)searchItems3()" placeholder="请输入用户名称或工号" data-i18n-placeholder="请输入用户名称或工号">
