...
<script>
	function ontdStyleWindowClose(data){
		if(data!=null){
		var id = data.id;
		Matrix.setFormItemValue('input001',id);
		}
	}
...
<script>function getParamsFortdStyleWindow(){var params='&';var value;return params;}isc.Window.create({ID:"MtdStyleWindow",id:"tdStyleWindow",name:"tdStyleWindow",autoCenter: true,position:"absolute",height: "550px",width: "700px",title: "请选择",canDragReposition: false,showMinimizeButton:true,showMaximizeButton:true,showCloseButton:true,showModalMask: false,modalMaskOpacity:0,isModal:true,autoDraw: false,headerControls:["headerIcon","headerLabel","minimizeButton","maximizeButton","closeButton"],getParamsFun:getParamsFortdStyleWindow,initSrc:"/mofficeV3/office/html5/select/SelectAllFlowActivity.jsp",src:"/mofficeV3/office/html5/select/SelectAllFlowActivity.jsp",showFooter: false });</script><script>MtdStyleWindow.hide();</script>
