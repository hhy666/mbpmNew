...
<script type="text/javascript">
	...
	function doubleClickReadMessage(url,messageId){
		if(url!=null&&　url.length>0){
			...
			var urlValue="<%=request.getContextPath()%>/"+url;
			
			openCtpWindow({'url':urlValue,'title':'查看消息'});
			//打开之后 修改为已读
	...
	function deleteMessages(data){
		var url ="/demo/foundation/message_deleteMessage.action";
				...
				<script> var MDataGrid001_DS=<%=request.getAttribute("lists")%>;
						 isc.MatrixListGrid.create({
						 	...
						 	fields:[
						 		...
						 		{title:"创建时间",matrixCellId:"createdDate",name:"createdDate",canEdit:false,width:'30%',type:'date'
						 		},
