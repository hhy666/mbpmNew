...
    }
		...
		var src = "<%=request.getContextPath()%>/office/performance/tabefficiency.jsp?templetId="+templetId+"&startTime="+startTime+"&endTime="+endTime;
	...
	isc.VLayout.create( {
		...
		members : [ isc.MatrixHTMLFlow.create( {
			...
			contentsType : "page",
				contentsURL : "<%=request.getContextPath()%>/office/performance/tabefficiency.jsp?templetId=&startTime=&endTime="
		}) ],
		canSelectText : true
	});
</script>
