...
<html>
  ...
  <script src="http://cdn.bootcss.com/jquery/1.11.1/jquery.min.js"></script>
    ...
    <script src="js/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" type="text/javascript"></script>
		...
		var src = "<%=request.getContextPath()%>/office/performance/tabissued.jsp?flowType="+flowType+"&status="+status+"&startTime="+startTime+"&endTime="+endTime;
					...
					<table id="table001" class="tableLayout" style="width: 100%;">
						<tr id="tr001">
							<td id="td001" class="tdLayout"
								...
								<label id="label001" name="label001" id="label001" style="font-weight:normal;">
									流程类型
								</label>
							</td>
	...
	//McomboBox001.setValue(null);
							...
							<td id="td008" class="tdLayout" rowspan="1" style="width: 50%;align: left;">
            ...
            <span class="glyphicon glyphicon-th"></span>
						...
						<tr id="tr002">
							<td id="td003" class="tdLayout" colspan="1"
								style="width: 20%; text-align: right;">
								<label id="label002" name="label002" id="label002" style="font-weight:normal;">
									状态
								</label>
							</td>
	...
	McomboBox002.displayValueMap = {'0':'已发和已办','1':'已发','2':'已办'};
