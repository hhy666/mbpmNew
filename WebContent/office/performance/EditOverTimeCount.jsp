...
    }
        ...
        var complete=Matrix.getFormItemValue("complete");
        var notFinish=Matrix.getFormItemValue("notFinish");
        var cutout=Matrix.getFormItemValue("cutout");
		var src = "<%=request.getContextPath()%>/office/performance/tabovertime.jsp?templetId="+templetId+"&startTime="+startTime+"&endTime="+endTime+"&complete="+complete+"&notFinish="+notFinish+"&cutout="+cutout;
	...
	isc.VLayout.create( {
		...
		members : [ isc.MatrixHTMLFlow.create( {
			...
			contentsType : "page",
				contentsURL : "<%=request.getContextPath()%>/office/performance/tabovertime.jsp?templetId=&startTime=&endTime="
		}) ],
		canSelectText : true
	});
</script>
	...
	Mform0.addField(templet);
							...
							<td id="td206" class="tdLayout"
									style="padding-left: 2px; padding-top: 2px; border-style: none;; height: 15px; width: 15%;"
									colspan="1">
									<div id="checkBoxGroup001_0_div" eventProxy="Mform0"></div>
									<script> var complete=isc.CheckboxItem.create({
															ID:"Mcomplete",
															name:"complete",
														...
														Mform0.addField(complete);
														Mform0.setValue("complete","1");
												</script>
								</td>
								<td id="td205" class="tdLayout"
									style="padding-left: 2px; padding-top: 2px; border-style: none;; height: 27px; width: 15%;"
									colspan="1">
									<div id="checkBoxGroup001_1_div" eventProxy="Mform0"></div>
									<script> var notFinish=isc.CheckboxItem.create({
															ID:"MnotFinish",
															name:"notFinish",
															editorType:"CheckboxItem",
														...
														Mform0.addField(notFinish);
														Mform0.setValue("notFinish","1");
													</script>
								</td>
								<td id="td204" class="tdLayout"
									...
									<script> var cutout=isc.CheckboxItem.create({
															ID:"Mcutout",
															name:"cutout",
															editorType:"CheckboxItem",
														...
														Mform0.addField(cutout);
														Mform0.setValue("cutout","1");
													</script>
								</td>
						...
						<tr id="tr003">
							<td id="td005" colspan="6" rowspan="1"
