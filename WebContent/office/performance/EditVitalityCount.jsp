...
    }
		...
		var src = "<%=request.getContextPath()%>/office/performance/tabvitality.jsp?userId="+userId+"&userName="+userName+"&type="+type+"&startTime="+startTime+"&endTime="+endTime;
	...
	isc.VLayout.create( {
		...
		members : [ isc.MatrixHTMLFlow.create( {
			...
			contentsType : "page",
				contentsURL : "<%=request.getContextPath()%>/office/performance/tabvitality.jsp?userId=&userName=&type=&startTime=&endTime="
		}) ],
		canSelectText : true
	});
</script>
					...
					<table id="table001" class="tableLayout" style="width: 100%;">
						<tr id="tr001">
							...
							<td id="td006" class="tdLayout" rowspan="1" style="width: 20%;">
								<div id="userName_div" eventProxy="Mform0" class="matrixInline"
									style=""></div>
								<script>
	...
	McomboBox002.displayValueMap = {'0':'本周','1':'本月','2':'全部','3':'任意'};
