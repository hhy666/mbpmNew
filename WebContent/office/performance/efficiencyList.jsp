...
<html>
	<head>
		...
		function showPenetration(record){
			if(record!=null){
			Mpenetration.initSrc="<%=request.getContextPath()%>/performance/pen_countEfficiency.action?templetId=${param.templetId}&startTime=${param.startTime}&endTime=${param.endTime}&piid="+record.piid;
			Mpenetration.src="<%=request.getContextPath()%>/performance/pen_countEfficiency.action?templetId=${param.templetId}&startTime=${param.startTime}&endTime=${param.endTime}&piid="+record.piid;
	...
	var Mform0 = isc.MatrixForm.create( {
		...
		name : "Mform0",
		position : "absolute",
		action : "<%=request.getContextPath()%>/performance/per_countEfficiency.action?templetId=${param.templetId}&startTime=${param.startTime}&endTime=${param.endTime}",
		canSelectText : true,
		fields : [ {
