...
<html>
	...
	var  str = "<%=request.getContextPath()%>/performance/pen_priEfficiency.action?templetId=${param.templetId}&startTime=${param.startTime}&endTime=${param.endTime}&piid=${param.piid}";
	...
	if(data!=null){
		var searchForm = document.getElementById("form0") ;
				searchForm.action = "<%=request.getContextPath()%>/performance/pen_exportEfficiency.action?templetId=${param.templetId}&startTime=${param.startTime}&endTime=${param.endTime}&complete=${param.complete}&notFinish=${param.notFinish}&cutout=${param.cutout}&piid=${param.piid}";
	...
	<body>
		...
		<div
			...
			<form id="form0" name="form0" eventProxy="Mform0" method="post"
				...
				{title:"处理人",matrixCellId:"starter",name:"starter",width:"40%",canEdit:false,editorType:'Text',type:'text'},
