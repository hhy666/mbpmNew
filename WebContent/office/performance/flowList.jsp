...
<html>
	<head>
		...
		function showPenetration(record){
			if(record!=null){
			Mpenetration.initSrc="<%=request.getContextPath()%>/performance/pen_pencountFlow.action?flowType=${param.flowType}&templetId=${param.templetId}&startTime=${param.startTime}&endTime=${param.endTime}&piid="+record.piid+"&depId="+record.depId;
			Mpenetration.src="<%=request.getContextPath()%>/performance/pen_pencountFlow.action?flowType=${param.flowType}&templetId=${param.templetId}&startTime=${param.startTime}&endTime=${param.endTime}&piid="+record.piid+"&depId="+record.depId;
