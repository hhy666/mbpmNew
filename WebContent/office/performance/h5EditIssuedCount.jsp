...
<script type="text/javascript">
		...
		function forwardPage(){
			...
			var src = "<%=path%>/office/performance/h5Tabissued.jsp?flowType="+flowType+"&status="+status+"&startTime="+startTime+"&endTime="+endTime;
...
<body>
	<form id="Form0" name="Form0" method="post" action="" style="margin: 0px; height: 100%;" enctype="application/x-www-form-urlencoded">
		...
		<div style="display:block;height:78%">
			<iframe id="InfoIframe" style="width:100%;top:30px;height: 100%" frameborder="0" src="<%=path%>/office/performance/h5Tabissued.jsp">
			</iframe>
		</div>
	</form>
</body>
