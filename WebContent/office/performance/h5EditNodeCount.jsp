...
<script type="text/javascript">
	...
	function forwardPage(){
		...
		var src = "<%=path%>/office/performance/h5Tabnode.jsp?templetId="+templetId+"&startTime="+startTime+"&endTime="+endTime;
...
<body>
	<form id="Form0" name="Form0" method="post" action="" style="margin: 0px; height: 100%;" enctype="application/x-www-form-urlencoded">
		...
		<div style="display:block;height:85%">
			<iframe id="InfoIframe" style="width:100%;top:30px;height: 100%" frameborder="0" src="<%=path%>/office/performance/h5Tabnode.jsp">
			</iframe>
		</div>
	</form>
</body>
