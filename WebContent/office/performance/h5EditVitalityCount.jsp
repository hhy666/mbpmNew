...
<title>综合分析列表</title>
	<script type="text/javascript">
		...
		function forwardPage(){
			...
			var src = "<%=path%>/office/performance/h5Tabvitality.jsp?userId="+userId+"&userName="+userName+"&type="+type+"&startTime="+startTime+"&endTime="+endTime;
...
<body>
	<form id="Form0" name="Form0" method="post" action="" style="margin: 0px; height: 100%;" enctype="application/x-www-form-urlencoded">
							...
							<tr>
								...
								<td class="tdLayout" style="width:15%">
									<div style='display: inline-table; vertical-align: middle; '>
										<input class="form-control" type="text" id="userName" name="userName"  onfocus="userSelect()">
									</div>
								</td>
								<td class="maintain_form_label2" style="width:15%">
									<label>时间</label>
		...
		<div style="display:block;height:78%">
			<iframe id="InfoIframe" style="width:100%;top:30px;height: 100%" frameborder="0" src="<%=path%>/office/performance/h5Tabvitality.jsp">
			</iframe>
		</div>
	</form>
</body>	
