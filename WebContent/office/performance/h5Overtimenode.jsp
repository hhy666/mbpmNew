...
<title>超时分析穿透查询</title>
<script type="text/javascript">
	function load(){
		var str = "<%=path%>/performance/pen_priOverTime.action?templetId=${param.templetId}&startTime=${param.startTime}&endTime=${param.endTime}&complete=${param.complete}&notFinish=${param.notFinish}&cutout=${param.cutout}&piid=${param.piid}";
	...
	function exportExcel(){
		...
		searchForm.action = "<%=path%>/performance/pen_exportOverTime.action?templetId=${param.templetId}&startTime=${param.startTime}&endTime=${param.endTime}&complete=${param.complete}&notFinish=${param.notFinish}&cutout=${param.cutout}&piid=${param.piid}";
	   			...
	   			<script>
	    			$(document).ready(function(){
						$("#DataGrid001_table").bootstrapTable({
							...
							url:'<%=path%>/performance/pen_h5CountOverTime.action',
							search: false, 
