...
<script type="text/javascript">
	//打印
	function load(){
		var str = "<%=path%>/performance/pen_priPenComprehensive.action?flowType=${param.flowType}&startTime=${param.startTime}&endTime=${param.endTime}&type=${param.type}&piid=${param.piid}";
	...
	function exportExcel(){
		...
		searchForm.action = "<%=path%>/performance/pen_exportComprehensiveNode.action?flowType=${param.flowType}&startTime=${param.startTime}&endTime=${param.endTime}&type=${param.type}&piid=${param.piid}";
	   			...
	   			<script>
	    			$(document).ready(function(){
						$("#DataGrid001_table").bootstrapTable({
							...
							url:'<%=path%>/performance/pen_h5PenComprehensive.action',
							search: false, 
