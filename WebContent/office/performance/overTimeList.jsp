...
<html>
	<head>
		...
		function showPenetration(record){
			if(record!=null){
			Mpenetration.initSrc="<%=request.getContextPath()%>/performance/pen_countOverTime.action?templetId=${param.templetId}&startTime=${param.startTime}&endTime=${param.endTime}&complete=${param.complete}&notFinish=${param.notFinish}&cutout=${param.cutout}&piid="+record.piid;
			Mpenetration.src="<%=request.getContextPath()%>/performance/pen_countOverTime.action?templetId=${param.templetId}&startTime=${param.startTime}&endTime=${param.endTime}&complete=${param.complete}&notFinish=${param.notFinish}&cutout=${param.cutout}&piid="+record.piid;
	...
	var Mform0 = isc.MatrixForm.create( {
		...
		name : "Mform0",
		position : "absolute",
		action : "<%=request.getContextPath()%>/performance/per_countOverTime.action?templetId=${param.templetId}&startTime=${param.startTime}&endTime=${param.endTime}&complete=${param.complete}&notFinish=${param.notFinish}&cutout=${param.cutout}",
		canSelectText : true,
		fields : [ {
