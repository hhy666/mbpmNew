...
<html>
	...
	var  str = "<%=request.getContextPath()%>/performance/pen_priPenComprehensive.action?flowType=${param.flowType}&startTime=${param.startTime}&endTime=${param.endTime}&type=${param.type}&piid=${param.piid}";
	...
	if(data!=null){
		var searchForm = document.getElementById("form0") ;
				searchForm.action = "<%=request.getContextPath()%>/performance/pen_exportComprehensiveNode.action?flowType=${param.flowType}&startTime=${param.startTime}&endTime=${param.endTime}&type=${param.type}&piid=${param.piid}";
