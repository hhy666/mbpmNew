...
(function () {
    ...
    CKEDITOR.env || (CKEDITOR.env = function () {
        ...
        if (b.ie) {
            // seeyon patch
            var v = a.match(/msie (\d+)/);
            if(v!=null){
                v = a.match(/msie (\d+)/)[1]
            }
            c = b.quirks || !document.documentMode ? parseFloat(v) : document.documentMode;
            if(isNaN(c)){
                        ...
                        for (; q;) {
                            ...
                            if (q.type == CKEDITOR.NODE_COMMENT) q = q.getPrevious();
                                ...
                                if (q.type == CKEDITOR.NODE_TEXT) {
                                    ...
                                    /[^\s\ufeff]/.test(k) && (q = null);
                                    p = /[\s\ufeff]$/.test(k)
                                } else if ((q.$.offsetWidth > 0 || b && q.is("br")) && !q.data("cke-bookmark"))
...
*/
            ...
            init: function (a) {
                ...
                a.addMode("wysiwyg", function (d) {
                    ...
                    e.setStyles({
                        // seeyon patch
                        width: "786px",
                        height:((typeof($) != 'undefined')&&$.v3x&&$.v3x.isMSIE7)?"98%":"100%"
                    });
    ...
    CKEDITOR.plugins.add("smiley", {
        requires: "dialog",
        init: function (a) {
            //因为便捷图片的统一更换这里 直接调用UC路径下的图片
    		//var testpath="http://10.5.6.240:88/seeyon/apps_res/uc/chat/image/face/"
            var urlinfo;
			if( this.path.indexOf("common")!=-1){
    		var urlhead=this.path.split("common");
    		var urlend="apps_res/uc/chat/image/face/";
    		urlinfo=urlhead[0]+urlend;
                //a.config.smiley_path = a.config.smiley_path || this.path + "images/";
            }else{
            urlinfo=this.path + "images/";
			}
    		a.config.smiley_path=a.config.smiley_path || urlinfo;
    ...
    //换新图片，并且暂时不现实图片提示信息
    CKEDITOR.config.smiley_images = "5_1.gif 5_2.gif 5_3.gif 5_4.gif 5_5.gif 5_6.gif 5_7.gif 5_8.gif 5_9.gif 5_10.gif 5_11.gif 5_12.gif 5_13.gif 5_14.gif 5_15.gif 5_16.gif 5_17.gif 5_18.gif 5_19.gif 5_20.gif 5_21.gif 5_22.gif 5_23.gif 5_24.gif 5_25.gif 5_26.gif 5_27.gif 5_28.gif 5_29.gif 5_30.gif 5_31.gif 5_32.gif".split(" ");
    CKEDITOR.config.smiley_descriptions = "";//"smiley;sad;wink;laugh;frown;cheeky;blush;surprise;indecision;angry;angel;cool;devil;crying;enlightened;no;yes;heart;broken heart;kiss;mail".split(";");
    (function () {
        function l(a, c) {
            var c = void 0 === c || c,
        ...
        init: function (b) {
            ...
            b.on("doubleclick", function (a) {
                ...
                if (!c.isReadOnly())
                    if (c.is("a")) {
                        // seeyon patch
                        // Fix OA-35505 CkEditor双击打开关联，在关联上点右键不显示编辑链接菜单
