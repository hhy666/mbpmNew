    ...
    FormatNumber.prototype = {
        init: function(settings) {
            ...
            settings = $.extend({
                ...
                changer: '[data-rule="number"]',
                decimal: 2,
                minus: true, //是否支持负数,默认不支持
                parent: 'body'
            }, settings);
            ...
            $(settings.changer, parent).on('change', function(e) {
            	var txt = $(this).val();
                formatTxt = _this.doFormat(txt);
                $("#"+this.id+"_text").val(formatTxt);
            });
            ...
            function getTxtCursorPosition(txtObj) {
                ...
                if (typeof(tempObj.selectionStart) != "undefined") { //非IE浏览器
