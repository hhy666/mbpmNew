...
;!function() {
	...
	C.prototype = [], C.prototype.constructor = C, w.extend = function() {
		...
		var e = this,
			t = e.config,
			n = (typeof (MatrixLang)!="undefined"?MatrixLang.laydatePropertys():
			{
				cn : {
					weeks : [ "日", "一", "二", "三", "四", "五", "六" ],
					time : [ "时", "分", "秒" ],
		...
		return n[typeof (MatrixLang)!="undefined"?MatrixLang.getLayDateLang():t.lang] || n.cn;//n[t.lang] || n.cn
		...
		if (t.zIndex && (i.style.zIndex = t.zIndex), w.each(new Array(2), function(e) {
				...
				return "datetime" === t.type && e.push('<span lay-type="datetime" class="laydate-btns-time">' + n.timeTips + "</span>"), w.each(t.btns, function(e, r) {
						var o = n.tools[r] || "btn";
						t.range && "now" === r || (a && "clear" === r && (o = "cn" === typeof (MatrixLang)!="undefined"?MatrixLang.getLayDateLang():t.lang? "重置" : "Reset"), i.push('<span lay-type="' + r + '" class="laydate-btns-' + r + '">' + o + "</span>"))
		...
		if (l.year < d[0] && (l.year = d[0], r.hint("最低只能支持到公元" + d[0] + "年")), l.year > d[1] && (l.year = d[1], r.hint("最高只能支持到公元" + d[1] + "年")), r.firstDate || (r.firstDate = w.extend({}, l)), c.setFullYear(l.year, l.month, 1), t = c.getDay(), a = n.getEndDate(l.month || 12, l.year), i = n.getEndDate(l.month + 1, l.year), w.each(y, function(e, n) {
			...
			}), w(f[0]).attr("lay-ym", l.year + "-" + (l.month + 1)), w(f[1]).attr("lay-ym", l.year + "-" + (l.month + 1)), "cn" === typeof (MatrixLang)!="undefined"?MatrixLang.getLayDateLang():s.lang? (w(f[0]).attr("lay-type", "year").html(l.year + "年"), w(f[1]).attr("lay-type", "month").html(l.month + 1 + "月")) : (w(f[0]).attr("lay-type", "month").html(m.month[l.month]), w(f[1]).attr("lay-type", "year").html(l.year)), u && (s.range && (e ? r.endDate = r.endDate || {
		...
		if(i=="val"&&e=="")w(a)["attr"]("title","");//清空日期框的value时，清空title,防止校验时取出。
