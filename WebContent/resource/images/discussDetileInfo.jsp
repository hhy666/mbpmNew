  ...
  <head>
	...
	<script type="text/javascript">
		...
		function openAttachmentDialog(){
			...
			window.open('UploadAppendix.rform?mBizId='+mBizId,'FileDialog','height='+iHeight+', width='+iWidth+', top='+iTop+',left='+iLeft+',toolbar=no, menubar=no, scrollbars=no, resizable=no,location=no,status=no');
		}	
	...
	            		var size = jsonObj[i].fileSize;
						...
						html += "<span style=\"margin-top:10px\" onclick=\"deleteFile('"+uuid+"','"+name+"')\"><img src=\"/moffice2/images/delete.jpg\" width=\"15px\" height=\"15px\" /></span>";
					}
    ...
    <table border="0" width="100%" cellpadding="1" cellspacing="0">
    	<tbody>
    		...
    		<tr>
    			<td>
					<div style="float:right;margin-right:15px">
    					<% if(userId.equals(reply.getString("replyerId")) ){
    					%>
